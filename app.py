...
def main():
    ...
    st.markdown("基于LangGraph的社交媒体热点分析AI代理")
    ...
    with st.sidebar:
        ...
        st.markdown(
            """
            社交媒体热点分析智能体系统是一个面向社交媒体分析与热点研究的智能辅助系统，

            旨在通过人工智能技术和智能体架构，实现从社交媒体数据到热点分析报告的全流程智能化支持。
    ...
    query = st.text_area(
        "输入您的研究问题",
        height=100,
        placeholder="例如：我想分析社交媒体上关于“2024年全球科技趋势”的热门话题，请帮我进行研究。",
        help="输入您的社交媒体热点分析问题",
    )
